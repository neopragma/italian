...
cards[cards.length] = new card("thank you","grazie","grazie.mp3")
cards[cards.length] = new card("please","per favore","per-favore.mp3")
cards[cards.length] = new card("sometimes","a volte","a-volte.mp3")
...
cards[cards.length] = new card("step by step","passo dopo passo","passo-dopo-passo.mp3")
...
cards[cards.length] = new card("Thank you (formal) for your patience","Grazie per la vostra pazienza","grazie-per-la-vostra-pazienza.mp3")
cards[cards.length] = new card("Thank you (informal) for your patience","Grazie per la tua pazienza","grazie-per-la-tua-pazienza.mp3")
